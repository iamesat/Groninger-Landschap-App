...
<title>Alle fotowedstrijden</title>
<body>
...
<div class="container">
    <div class="card fotowedstrijd-page">
        <div class="card-body text-center">
            <h3 class="wedstrijd-titel">Maak jij deze foto het mooist na?</h3>
            <p class="wedstrijd-route">Wandelroute Ennemaborgh</p>
            <img src="assets/images/fotorollen/ennemaborgh.jpg" class="wedstrijd-foto" alt="...">
            <div class="row text-center pt-3">
                <div class="col">
                    <p class="wedstrijd-p">
                        Goud<br>
